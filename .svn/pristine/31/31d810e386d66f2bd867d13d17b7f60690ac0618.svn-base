<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambioPassVecino.aspx.cs" Inherits="LaHerradura.CambioPassVecino" %>
                ...
                <div class="col-md-8 col-md-offset-2" id="divCambioPass" runat="server">
                    <div class="box box-primary" style="border-top-color: #3c4c39;">
                        <div class="box-header" style="text-align: center;">
                            <img src="https://aclaherradura.com.ar/img/mailRecuperoPass.png" style="width: 100%;" />
