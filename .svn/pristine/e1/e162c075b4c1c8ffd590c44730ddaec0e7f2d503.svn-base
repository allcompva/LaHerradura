<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MPBack.Master" AutoEventWireup="true" CodeBehind="InformeGastos.aspx.cs" Inherits="LaHerradura.Back.InformeGastos" %>
                ...
                <div class="box box-widget widget-user-2">
                    ...
                    <div class="widget-user-header bg-aqua-active">
                        ...
                        <h2 class="widget-user-username"
                            style="margin-top: 15px; margin-bottom: 15px;">Informe Gastos</h2>
                    </div>
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="box">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Facturas
                                            <strong id="lblDeuda" runat="server"></strong>
                                                <strong>-</strong>
                                                Facturas cargadas: <strong id="lblCantCta" runat="server"></strong>
                                            </h3>
                                        </div>
                                        ...
                                        <div class="box-body">
                                            <div class="row" style="padding-top: 20px; margin: 0; border: solid 1px lightgray; background-color: lightseagreen;">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label style="color: white;">Filtrar por Cuenta</label>
                                                        <asp:DropDownList ID="DDLFiltro"
                                                            AutoPostBack="true"
                                                            OnSelectedIndexChanged="DDLFiltro_SelectedIndexChanged"
                                                            CssClass="form-control"
                                                            runat="server">
                                                            <asp:ListItem Text="Todas" Value="1" Selected></asp:ListItem>
                                                            <asp:ListItem Text="Cuenta Pasivo" Value="2"></asp:ListItem>
                                                            <asp:ListItem Text="Cuenta Gasto" Value="3"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-md-3" id="divCuenta" runat="server" visible="false">
                                                    <div class="form-group">
                                                        <label style="color: white;">Cuenta</label>
                                                        <asp:DropDownList ID="DDLCuenta"
                                                            AutoPostBack="true"
                                                ...
                                                <div class="col-md-12">
                                                    <asp:GridView
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="FACTURA" HeaderText="Factura" ItemStyle-Wrap="false" />
                                                            <asp:BoundField DataField="CONCEPTO" HeaderText="Concepto" />
                                                            <asp:BoundField DataField="CUENTA_PASIVO" HeaderText="Cuenta Pasivo" />
                                                            <asp:BoundField DataField="CUENTA_GASTO" HeaderText="Cuenta Gasto" />
                                                            <asp:BoundField DataField="NRO_ORDEN_PAGO" HeaderText="Orden Pago" />
                                                            <asp:BoundField DataField="MONTO" HeaderText="Monto" DataFormatString="{0:c}" ItemStyle-Wrap="false" />
                                                        </Columns>
                                                    </asp:GridView>
                                                </div>
                                            </div>
