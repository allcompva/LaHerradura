...
namespace LaHerradura.Back
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        //{
        //    List<DAL.DetLiq> lst = DAL.DetLiq.getDetalleAnio(.Year);
        //    List<object> chartData = new List<object>();
        ...
        //{
        //    List<DAL.DetLiq> lst = DAL.DetLiq.getDetalleAnioSin(.Year);
        //    List<object> chartData = new List<object>();
        //    decimal total = lst.Sum(d => d.TOTAL);
        //    foreach (var item in lst)
        //    {
        ...
        //{
        //    List<DAL.DetLiq> lst = DAL.DetLiq.getMediosPagoAnual(.Year);
        //    List<object> chartData = new List<object>();
        //    decimal total = lst.Sum(d => d.TOTAL);
        //    foreach (var item in lst)
        //    {
        ...
        //    List<DAL.DetLiq> objTotFacturado = DAL.DetLiq.getTotGral(.Year);
        //    gvResumen1.DataSource = objTotFacturado;
        //    gvResumen1.DataBind();

        //    gvResumen.DataSource = DAL.DetLiq.getDetalleAnio(.Year);
        //    gvResumen.DataBind();

        //    List<DAL.CTACTE_EXPENSAS> lst = DAL.CTACTE_EXPENSAS.readAnio(.Year);
