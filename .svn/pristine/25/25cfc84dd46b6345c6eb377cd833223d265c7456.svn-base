<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MPBack.Master" AutoEventWireup="true" CodeBehind="Iva_Ventas.aspx.cs" Inherits="LaHerradura.Back.Iva_Ventas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">Libro Iva Ventas</h3>
        </div>
        <div class="box-body">
            <div class="col-md-3">
            ...
            <div class="col-md-12">
                <asp:GridView
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NRO_CTA" HeaderText="N° de Cuenta"/>
