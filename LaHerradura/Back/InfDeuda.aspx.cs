...
namespace LaHerradura.Back
{
    public partial class InfDeuda : System.Web.UI.Page
    {
        ...
        this.Master.FindControl("liInmuebles") as HtmlGenericControl;
                ...
                List<DAL.INFORME_PERIODOS> lstDet = DAL.INFORME_PERIODOS.readPeriodos();
        ...
        protected void gvT_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    List<DAL.INFORME_PERIODOS> lstInfTotal =
                        DAL.INFORME_PERIODOS.readPeriodos(obj.NRO_CTA);
