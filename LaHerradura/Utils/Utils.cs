...
namespace LaHerradura.Utils
{
    public class Utils
    {
        ...
        public static string ArmoCBarra(string cuit, int codComprobante,
     int ptoVta, Int64 cae, DateTime fecVenc)
        {
            Char pad;
        ...
        //    //DateTime fechatemp = new DateTime(2020, 02, 2);
        ...
        public static int UltimoDiadelMes(DateTime fecha)
        {
            //DateTime fechatemp = DateTime.Today;
            //DateTime fechatemp = new DateTime(2022, 12, 31);
