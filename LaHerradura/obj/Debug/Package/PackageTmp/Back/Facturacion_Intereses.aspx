<%@ Page Title="" Language="C#" MasterPageFile="~/MP/MPBack.Master" AutoEventWireup="true" CodeBehind="Facturacion_Intereses.aspx.cs" Inherits="LaHerradura.Back.Facturacion_Intereses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hMonto" runat="server" />
    <!-- Main content -->
                ...
                <div class="box box-widget widget-user-2">
                    ...
                    <div class="widget-user-header bg-aqua-active">
                        ...
                        <h2 class="widget-user-username"
                            style="margin-top: 15px; margin-bottom: 15px;">Emisión de Notas de Débito</h2>
                    </div>
                    <div class="box-body" style="padding: 20px;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <a href="#" class="btn btn-default"
                                        ...
                                        <span
                                            class="fa fa-download">&nbsp;Emitir Notas de Dédito</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Total a Facturar:
                                                        <strong id="lblDeuda" runat="server"></strong>
                                    <strong>-</strong>
                                    Notas de Débito a emitir: <strong id="lblCantCta" runat="server"></strong>
                                </h3>
                            </div>
                            ...
                            <div class="box-body">
                                <asp:GridView
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NRO_RECIBO" HeaderText="N° Recibo" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <a target="_blank" href="Reportes/Recibo.aspx?nroRecibo=<%#Eval("NRO_RECIBO")%>">
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <a href="#"
                                                    onclick="abrirModalAddComprobante('<%#Eval("NRO_CTA")%>','<%#Eval("NRO_RECIBO")%>','<%#Eval("MONTO")%>')">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Facturación Intereses</h4>
                </div>
    ...
    <script>
        ...
        function abrirModalAddComprobante(ID, NRO_RECIBO, MONTO) {
            $("#ContentPlaceHolder1_hIdCta").val(ID);
            $("#ContentPlaceHolder1_hNroRecibo").val(NRO_RECIBO);
            $("#ContentPlaceHolder1_hMonto").val(MONTO);
